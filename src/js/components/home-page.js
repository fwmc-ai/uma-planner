...
(function() {
    ...
    function createHomePage() {
        ...
        [3, 2, 1].forEach(rarity => {
            ...
            // Special handling for anime collaboration characters
            const isSpecialCharacter = character.id.includes('beyond_the_horizon') || character.id.includes('end_of_skies');
            let imagePath;
